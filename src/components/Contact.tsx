...
export default function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 61 9.9335-8258",
      link: "https://wa.me/5561993358258?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "zerobyrox@gmail.com",
      link: "mailto:zerobyrox@gmail.com?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "Brazlândia - DF",
      description: "Quadra 5 Norte",
      link: "https://goo.gl/maps/VQ46bk7rgos1ZvzE6",
          ...
          <div className="basis-2/3">
            ...
            <form ref={form} onSubmit={sendEmail}>
              ...
              <div>
                <button
                  type="submit"
                  className="button flex items-center gap-2 text-blue-700 bg-white"
                  disabled={loading}
                >
